                        ...
                        <div class="row">
                            <div class="form-group mt-3">
                                <input type="text" name="nama" value="<?= $dt_siswa['nama'] ?>" class="form-control"
                                    style="height: 50px; border-radius: 10px;" placeholder="Masukan Nama" required>
                            </div>
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" value="<?= $dt_siswa['kelas'] ?>" name="kelas"
                                    style="height: 50px; border-radius: 10px;" placeholder="Masukan Kelas" required>
                            </div>
                        </div>
                        <div class="form-group mt-3">
                            <input type="email" class="form-control" value="<?= $dt_siswa['email'] ?>" name="email"
                                id="email" style="height: 50px; border-radius: 10px;" placeholder="Masukan Email"
                                required>
                        </div>
                        <div class="form-group mt-3">
                            <input type="password" class="form-control" name="password" id="password"
                                style="height: 50px; border-radius: 10px;" placeholder="Masukan Password Baru">
                        </div>
